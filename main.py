...
API_ID = int(os.environ.get("API_ID", 21155472))
API_HASH = os.environ.get("API_HASH", "9eeb9128f391029ed536846341137e65")
BOT_TOKEN = os.environ.get("BOT_TOKEN", "7941240232:AAFeoihry4Mg8oKkvrICvs0hGO0603kNPys")
